      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between border-b border-gray-800 pb-5 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-400">All your favorite movies saved in one place.</p>
            </div>
          </div>
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-24 bg-gray-900/40 border border-gray-800 rounded-xl p-8 max-w-xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1 mb-6">Heart movies while exploring to save them here.</p>
            <Link
              to="/"
              className="px-6 py-2.5 rounded-xl bg-red-600 text-white font-medium text-sm transition-colors shadow-lg shadow-red-600/25 inline-block"
            >
              Explore Movies
            </Link>
          </div>
